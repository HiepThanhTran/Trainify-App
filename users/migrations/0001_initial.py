    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(db_index=True, editable=False, max_length=10, null=True, unique=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('AD', 'Administrator'), ('STU', 'Sinh viên'), ('ASST', 'Trợ lý sinh viên'), ('SPC', 'Chuyên viên cộng tác sinh viên')], default='STU', max_length=4)),
        ...
        migrations.CreateModel(
            name='Specialist',
            fields=[
                ('assistant_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='users.assistant')),
        ...
        migrations.AddField(
            model_name='assistant',
            name='faculty',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='schools.faculty'),
        ),
        migrations.CreateModel(
            name='Student',
            fields=[
