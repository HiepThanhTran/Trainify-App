    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('OFFICER', 'Chuyên viên cộng tác sinh viên'), ('STUDENT_ASSISTANT', 'Trợ lý sinh viên'), ('STUDENT', 'Sinh viên'), ('ADMIN', 'Administrator')], default='Sinh viên', max_length=50)),
                ...
                ('address', models.CharField(blank=True, max_length=255, unique=True)),
