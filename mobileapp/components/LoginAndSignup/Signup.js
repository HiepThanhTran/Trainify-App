                ...
                <View style={LoginAndRegisterStyles.LoginContainer}>
                    ...
                    <View style={LoginAndRegisterStyles.TitleAndForm}>
                        ...
                        <View style={LoginAndRegisterStyles.TitleContainer}>
                            <Animated.Text entering={FadeInUp.duration(1000).springify()} style={[MyStyles.Bold, LoginAndRegisterStyles.Title]}>Đăng ký</Animated.Text>
                        </View>
                        ...
                        <View style={LoginAndRegisterStyles.Form}>
                            ...
                            <Animated.View entering={FadeInDown.delay(600).duration(1000).springify()} style={LoginAndRegisterStyles.Input}>
                                <TextInput 
                            ...
                            <Animated.View entering={FadeInDown.delay(800).duration(1000).springify()} style={{ width: '100%' }}>
                                ...
                                <Text style={[MyStyles.Bold, LoginAndRegisterStyles.ButtonText, { letterSpacing: 1 }]}>Đăng ký</Text>
                                </TouchableOpacity>
                            </Animated.View>
                            ...
                            <Animated.View entering={FadeInDown.delay(800).duration(1000).springify()} style={LoginAndRegisterStyles.Detail}>
                                ...
                                <TouchableOpacity onPress={() => navigation.push('Login')}>
                                    <Text style={[MyStyles.Bold, { color: '#1873bc' }, { marginLeft: 5 }]}>Đăng nhập</Text>
                                </TouchableOpacity>
                            </Animated.View>
                        </View>
                    </View>
