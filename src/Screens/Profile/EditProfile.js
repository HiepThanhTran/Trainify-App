         ...
         <View style={GlobalStyle.BackGround}>
            <ScrollView showsVerticalScrollIndicator={false}>
               <DismissKeyboard onPress={handleOnPressWithoutFeedback}>
                  ...
                  <View style={EditProfileStyle.TabContainer}>
                     {tabsContent.editProfile.map((f) => (
                        <TouchableOpacity
                           key={f.name}
                           style={EditProfileStyle.TabButton}
                           disabled={f.name === tab ? true : false}
                           onPress={() => handleChangeTab(f.name)}
                        >
                           <Text
                              style={{
                                 ...EditProfileStyle.TabText,
                                 ...(f.name === tab ? { fontFamily: Theme.Bold, color: 'black' } : {}),
                              }}
                           >
                              {f.label}
                           </Text>
                           <View style={{ ...EditProfileStyle.TabDot, opacity: f.name === tab ? 1 : 0 }} />
                        </TouchableOpacity>
                     ))}
                  </View>
